                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(transactions()[index].title, style: textStyle.bodyLarge,),
                              Text(transactions()[index].date, style: textStyle.titleMedium,),
                            ],
                          ),
                        ),
                        Text(transactions()[index].amount, style: textStyle.bodyMedium,),
                      ],
                    ),
                  );
                }),
